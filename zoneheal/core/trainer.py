...
from zoneheal.core.rollout import rollout
from zoneheal.heal.healing import HealLog, PolicyFlapMonitor, RollbackGuard
...
def regime_health(state):
    ...
    from zoneheal.envs.probes import HEALTH
